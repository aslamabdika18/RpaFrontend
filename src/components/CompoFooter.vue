  ...
  <footer class="bg-primary  text-white py-8">
    <div class="container mx-auto text-center">
      <div class="mb-6 flex justify-center items-center space-x-6">
        ...
        <a href="https://twitter.com" target="_blank" class="text-white hover:text-green-300 transition-colors duration-300">
      ...
      <p class="text-lg">&copy; 2025 RPA Aceh. All Rights Reserved.</p>
    </div>
  </footer>
</template>
